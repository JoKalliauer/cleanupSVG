...
svgo -i ${file} -o $i -p 2 $META --enable=removeScriptElement --disable=removeXMLProcInst --disable=removeUnknownsAndDefaults --disable=mergePaths $INDENT --enable=convertPathData --disable=convertStyleToAttrs
