...
#  sed -ri 's/[[:space:]]*<rect /\n<rect /g' $i #deactivated for Flow2TextBySed
 ...
 sed -ri 's/\n\n/\n/g' $i
   ...
   sed -ri 's/ systemLanguage=/\n \nsystemLanguage=/g' $i


   #<switch > <text transform="translate(140.25 -100.8)" font-family="Liberation Sans,Arial" font-size="7">Kalpa</text> </switch>
   #<switch > <text transform="translate(724.51 -32.1)" font-family="Liberation Sans,Arial" font-size="8">400</text> </switch>
   #<switch     > <text transform="translate(610.15 206.69)" fill="#fff" font-family="Liberation Sans,Arial" font-size="5">31</text> </switch>
   #<switch > <text transform="translate(86.95 69.77)" font-family="Liberation Sans,Arial" font-size="24" font-style="italic" font-weight="bold">NEW DELHI</text> </switch>
   sed -ri 's/<switch[[:space:]]*> (<text[-[:alnum:]=\"# .,()]*>[[:alnum:] ()º.]*<\/text>) <\/switch>/\1\n \n/g' $i
