...
do
 if [ -f "$fileSource" ]; then    
  ...
  if [ "$outputType" = "png" ];then
   ...
   /cygdrive/c/PrgmPort/inkscape/inkscape.exe ./${file}u.svg --verb=EditSelectAll --verb=SelectionUnGroup --verb=SelectionUnGroup --verb=SelectionUnGroup --verb=SelectionUnGroup --verb=SelectionUnGroup --verb=FileSave --verb=FileClose --verb=FileQuit
