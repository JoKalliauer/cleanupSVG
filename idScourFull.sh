...
scour -i ${file} -o $i --strip-xml-space --remove-metadata --renderer-workaround  --remove-descriptions --set-precision=5 --set-c-precision=5 --remove-descriptive-elements 
