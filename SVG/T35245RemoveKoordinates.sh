...
sed -ri "s/<tspan([-[:alnum:]\.\"\#\ =]*) x=\"([-[:digit:]\.]+)( |,)([-[:digit:]\. ,]+)\"([-[:alnum:]\.\"\#\ =]*)>([-[:alnum:] \'\+=\.\%\(\)→\“\”,\/_:*]|\[|\])/<tspan x=\"\2\"\1\5>\6/g" $i # remove multipe x-koordinates in tspan (librsvg-Bug)
sed -ri "s/<tspan([-[:alnum:]\.\"\#\ =]*) x=\"([-[:digit:]\.]+)( |,)([-[:digit:]\. ,]+)\"([-[:alnum:]\.\"\#\ =]*)>([-[:alnum:] \'\+=\.\%\(\)→\“\”,\/_:*]|\[|\])/<tspan x=\"\2\"\1\5>\6/g" $i # remove multipe x-koordinates in tspan (librsvg-Bug)
sed -ri "s/<tspan([-[:alnum:]\.\"\#\ =]*) x=\"([-[:digit:]\.]+)( |,)([-[:digit:]\. ,]+)\"([-[:alnum:]\.\"\#\ =]*)>([-[:alnum:] \'\+=\.\%\(\)→\“\”,\/_:*]|\[|\])/<tspan x=\"\2\"\1\5>\6/g" $i # remove multipe x-koordinates in tspan (librsvg-Bug)
sed -ri "s/<tspan([-[:alnum:]\.\"\#\ =]*) x=\"([-[:digit:]\.]+)( |,)([-[:digit:]\. ,]+)\"([-[:alnum:]\.\"\#\ =]*)>([-[:alnum:] \'\+=\.\%\(\)→\“\”,\/_:*]|\[|\])/<tspan x=\"\2\"\1\5>\6/g" $i # remove multipe x-koordinates in tspan (librsvg-Bug)
sed -ri "s/<tspan([-[:alnum:]\.\"\#\ =]*) x=\"([-[:digit:]\.]+)( |,)([-[:digit:]\. ,]+)\"([-[:alnum:]\.\"\#\ =]*)>([-[:alnum:] \'\+=\.\%\(\)→\“\”,\/_:*]|\[|\])/<tspan x=\"\2\"\1\5>\6/g" $i # remove multipe x-koordinates in tspan (librsvg-Bug)
...
sed -ri "s/<tspan([-[:alnum:]\.\"\#\ =\(\)]*) dy=\"([-[:digit:]\.]+)( |,)([-[:digit:]\. ,]+)\"([-[:alnum:]\.\"\#\ =]*)>([-[:alnum:] \'\+=\.\%\(\)→\“\”,])/<tspan dy=\"\2\"\1\5>\6/g" $i # remove multipe dy-koordinates in tspan (librsvg-Bug)
